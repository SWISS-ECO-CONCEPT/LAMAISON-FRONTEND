  ...
  return (
    <div className="mt-24 px-4 max-w-lg mx-auto">
      ...
      <div className="bg-white shadow-lg rounded-2xl px-8 py-10 space-y-6">
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">Email <span className="text-gray-400">*</span></label>
          <input
            type="email"
            name="email"
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-gray-700 mb-1">{t('connexion.mdp')} <span className="text-gray-400">*</span></label>
          <input
            type="password"
            name="password"
