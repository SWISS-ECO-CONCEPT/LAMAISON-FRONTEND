...
const Navbar: React.FC = () => {
  ...
  const { user } = useUser()
  return (
    <header className="fixed top-0 z-50 w-full bg-green-600 backdrop-blur-sm text-white fixed top-0 left-0 right-0 w-full z-50 shadow-md">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {menuOpen && (
          <div className="md:hidden mx-auto max-w-6xl px-4 pb-4 pt-2 space-y-3 bg-green-600 text-sm">
